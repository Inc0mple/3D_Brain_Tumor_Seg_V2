...
class ONet3d_v3_GELU(nn.Module):
    def __init__(self, in_channels, n_classes, n_channels):
        ...
        self.enc1_top = DownSingle(n_channels, 2 * n_channels, kernel_size=1, padding=0)
        self.enc2_top = DownSingle(2 * n_channels, 4 * n_channels, kernel_size=1, padding=0)
        self.enc3_top = DownSingle(4 * n_channels, 8 * n_channels, kernel_size=1, padding=0)
        self.enc4_top = DownSingle(8 * n_channels, 8 * n_channels, kernel_size=1, padding=0)
        ...
        self.dec1_top = UpSingle(16 * n_channels, 4 * n_channels, kernel_size=1, padding=0)
        self.dec2_top = UpSingle(8 * n_channels, 2 * n_channels, kernel_size=1, padding=0)
        self.dec3_top = UpSingle(4 * n_channels, n_channels, kernel_size=1, padding=0)
        self.dec4_top = UpSingle(2 * n_channels, n_channels, kernel_size=1, padding=0)
